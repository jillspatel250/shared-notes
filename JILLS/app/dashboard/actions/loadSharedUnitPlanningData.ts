...
export const loadSharedUnitPlanningData = async (subjectId: string, facultyId: string) => {
  try {
    const supabase = await createClient()

    console.log("🔍 Loading shared unit planning data for subject:", subjectId)

    // Get any form for this subject (since they should all be the same for shared subjects)
    ...
    console.error("Error in loadSharedUnitPlanningData:", error)
